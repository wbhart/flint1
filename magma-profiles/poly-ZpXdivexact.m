...
target_description := "MAGMA polynomial factorisation in Z/pZ[x] over various lengths and bitsizes, NON-NEGATIVE coefficients only";


max := 4000000;   // maximum total length of input polys
