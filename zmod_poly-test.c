...
int test___zmod_poly_normalise()
{
   ...
   for (count1 = 0; (count1 < 100000) && (result == 1) ; count1++)
   {
      ...
      randpoly(poly, length, modulus); 
		...
		ulong i;
		for (i = nz_coeff + 1; i < length; i++) poly->coeffs[i] = 0L;
      poly->length = length;
...
int test_zmod_poly_sqr_classicalKS()
{
   ...
   for (count1 = 0; (count1 < 50) && (result == 1); count1++)
   {
      ...
      unsigned long count2;
      for (count2 = 0; (count2 < 50) && (result == 1); count2++)
      {
         unsigned long length1 = randint(400);
   ...
   for (count1 = 0; (count1 < 100) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         if (length1 + length2 > 1) trunc = randint(2*(length1 + length2 - 1));
            ...
            zmod_poly_mul_KS(res1, pol1, pol2, 0);
            zmod_poly_truncate(res1, trunc);
            zmod_poly_mul_trunc_n(pol1, pol1, pol2, trunc);
   ...
   for (count1 = 0; (count1 < 100) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         if (length1 + length2 > 1) trunc = randint(2*(length1 + length2 - 1));
            ...
            zmod_poly_mul_KS(res1, pol1, pol2, 0);
            zmod_poly_truncate(res1, trunc);
            zmod_poly_mul_trunc_n(pol2, pol1, pol2, trunc);
...
int test_zmod_poly_mul_trunc_n_precache()
{
   ...
   unsigned long count1;
   for (count1 = 0; (count1 < 30) && (result == 1); count1++)
   {
      bits = randint(FLINT_BITS-2)+2;
      unsigned long modulus;
   ...
   for (count1 = 0; (count1 < 30) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 30) && (result == 1); count2++)
      {
         ...
         trunc = randint(length1 + length2 - 2000)+2000;
            ...
            zmod_poly_mul_trunc_n_precache(pol1, pol1, pre, trunc);
            zmod_poly_mul_precache_clear(pre);
   ...
   for (count1 = 0; (count1 < 30) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 30) && (result == 1); count2++)
      {
         ...
         unsigned long length2 = randint(2000)+2000;
            ...
            zmod_poly_mul_precache(pol1, pol1, pre);
            zmod_poly_mul_precache_clear(pre);
   ...
   for (count1 = 0; (count1 < 30) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 30) && (result == 1); count2++)
      {
         ...
         unsigned long trunc = length1;
            ...
            for (i = 0; i < trunc/2; i++)
               res1->coeffs[i] = 0L;
            zmod_poly_mul_KS_middle(pol1, pol1, pol2, 0, trunc);
   ...
   for (count1 = 0; (count1 < 30) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 30) && (result == 1); count2++)
      {
         ...
         unsigned long trunc = length1;
            ...
            for (i = 0; i < trunc/2; i++)
               res1->coeffs[i] = 0L;
            zmod_poly_mul_KS_middle(pol2, pol1, pol2, 0, trunc);
   ...
   for (count1 = 0; (count1 < 30) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 30) && (result == 1); count2++)
      {
         ...
         unsigned long trunc = length1;
            ...
            for (i = 0; i < trunc/2; i++)
               res1->coeffs[i] = 0L;
            zmod_poly_mul_middle(res2, pol1, pol2, trunc);
   ...
   for (count1 = 0; (count1 < 30) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 30) && (result == 1); count2++)
      {
         ...
         unsigned long trunc = length1;
            ...
            for (i = 0; i < trunc/2; i++)
               res1->coeffs[i] = 0L;
            zmod_poly_mul_middle(pol1, pol1, pol2, trunc);
   ...
   for (count1 = 0; (count1 < 30) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 30) && (result == 1); count2++)
      {
         ...
         unsigned long trunc = length1;
            ...
            for (i = 0; i < trunc/2; i++)
               res1->coeffs[i] = 0L;
            zmod_poly_mul_middle(pol2, pol1, pol2, trunc);
   ...
   for (count1 = 0; (count1 < 30) && (result == 1); count1++)
   {
 	   ...
 	   for (count2 = 0; (count2 < 30) && (result == 1); count2++)
      {
         ...
         for (i = 0; i < trunc/2; i++)
            res1->coeffs[i] = 0L;
		   zmod_poly_mul_trunc_n_precache_init(pre, pol2, 0, length2);
         zmod_poly_mul_middle_precache(pol1, pol1, pre, trunc);
         zmod_poly_mul_precache_clear(pre);
...
int test_zmod_poly_mul_trunc_left_n()
{
   ...
   for (count1 = 0; (count1 < 50) && (result == 1); count1++)
   {
      ...
      unsigned long count2;
      for (count2 = 0; (count2 < 25) && (result == 1); count2++)
      {
         unsigned long length1 = randint(400);
         unsigned long length2 = randint(400);
   ...
   for (count1 = 0; (count1 < 50) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 25) && (result == 1); count2++)
      {
         ...
         if (length1 + length2 > 1) trunc = randint(2*(length1 + length2 - 1));
            ...
            zmod_poly_mul_classical(res1, pol1, pol2);
            zmod_poly_mul_trunc_left_n(pol1, pol1, pol2, trunc);
            
            unsigned long i;
            for (i = trunc; i < res1->length; i++)
               if (res1->coeffs[i] != pol1->coeffs[i]) result = 0;
   ...
   for (count1 = 0; (count1 < 50) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 25) && (result == 1); count2++)
      {
         ...
         if (length1 + length2 > 1) trunc = randint(2*(length1 + length2 - 1));
            ...
            zmod_poly_mul_classical(res1, pol1, pol2);
            zmod_poly_mul_trunc_left_n(pol2, pol1, pol2, trunc);
            
            unsigned long i;
            for (i = trunc; i < res1->length; i++)
               if (res1->coeffs[i] != pol2->coeffs[i]) result = 0;
...
int test_zmod_poly_divrem_basecase()
{
   int result = 1;
   zmod_poly_t pol1, pol2, res1, Q, Q2, R;
   unsigned long bits;
   
   unsigned long count1;
   for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      bits = randint(FLINT_BITS-2)+2;
      unsigned long modulus;
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            if (pol2->length)
            {
               zmod_poly_divrem_basecase(Q, R, res1, pol2);
   ...
   for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            if (pol2->length)
            {
               zmod_poly_divrem_basecase(res1, R, res1, pol2);
	...
	for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            if (pol2->length)
            {
               zmod_poly_divrem_basecase(Q2, R, pol1, pol2);
               zmod_poly_divrem_basecase(Q, pol1, pol1, pol2);
         
               result &= zmod_poly_equal(Q, Q2);
               result &= zmod_poly_equal(R, pol1);
            }
...
int test_zmod_poly_rem_basecase()
{
   int result = 1;
   zmod_poly_t pol1, pol2, Q, R, R2;
   unsigned long bits;
   ...
   for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            if (pol2->length)
            {
               zmod_poly_divrem_basecase(Q, R, pol1, pol2);
               zmod_poly_rem_basecase(R2, pol1, pol2);
         
               result &= zmod_poly_equal(R, R2);
            }
	...
	for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            {
               zmod_poly_divrem_basecase(Q, R, pol1, pol2);
               zmod_poly_rem_basecase(pol1, pol1, pol2);
   ...
   for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            if (pol2->length)
            {
               zmod_poly_divrem_newton(Q, R, pol1, pol2);
               zmod_poly_rem_newton(R2, pol1, pol2);
	...
	for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            {
               zmod_poly_divrem_newton(Q, R, pol1, pol2);
               zmod_poly_rem_newton(pol1, pol1, pol2);
	...
	for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            {
               zmod_poly_divrem_basecase(Q, R, pol1, pol2);
               zmod_poly_rem(pol2, pol1, pol2);
         
               result &= zmod_poly_equal(R, pol2);
            }
...
int test_zmod_poly_divrem_q1()
{
   int result = 1;
   zmod_poly_t pol1, pol2, Q, R, Q2, R2;
   unsigned long bits;
   ...
   for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         unsigned long length1 = randint(100)+2;
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            do randpoly(pol1, length1, modulus);
				while (pol1->length < length1);

            do randpoly(pol2, length1 - 1, modulus);
            while (pol2->length < length1 - 1);

            zmod_poly_divrem_basecase(Q, R, pol1, pol2);
            zmod_poly_divrem_q1(Q2, R2, pol1, pol2); 
   ...
   for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            zmod_poly_divrem_basecase(Q, R, pol1, pol2);
            zmod_poly_divrem_q1(Q2, pol1, pol1, pol2); 
	...
	for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            zmod_poly_divrem_basecase(Q, R, pol1, pol2);
            zmod_poly_divrem_q1(pol1, R2, pol1, pol2); 
   ...
   for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            zmod_poly_divrem_basecase(Q, R, pol1, pol2);
            zmod_poly_rem_q1(pol1, pol1, pol2); 
   ...
   for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            do randpoly(pol2, length1, modulus);
            while (pol2->length < length1);

            zmod_poly_divrem_basecase(Q, R, pol1, pol2);
            zmod_poly_divrem_q0(Q2, R2, pol1, pol2); 
   ...
   for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            zmod_poly_divrem_basecase(Q, R, pol1, pol2);
            zmod_poly_divrem_q0(Q2, pol1, pol1, pol2); 
	...
	for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            zmod_poly_divrem_basecase(Q, R, pol1, pol2);
            zmod_poly_divrem_q0(pol1, R2, pol1, pol2); 
   ...
   for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            zmod_poly_divrem_basecase(Q, R, pol1, pol2);
            zmod_poly_rem_q0(pol1, pol1, pol2); 
   ...
   for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            {
               zmod_poly_divrem_newton(Q, R, pol1, pol2);
               zmod_poly_divrem_newton(Q2, pol1, pol1, pol2);
   ...
   for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            if (pol2->length)
            {
               zmod_poly_divrem_newton(res1, R, res1, pol2);
   ...
   for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            if (pol2->length)
            {
               zmod_poly_set(Q,pol2);
               zmod_poly_divrem(pol2, R, res1, pol2);
         
               result &= zmod_poly_equal(pol2, pol1);
            }
   ...
   for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            if (pol2->length)
            {
               zmod_poly_set(Q,res1);
               zmod_poly_divrem(res1, R, res1, pol2);
   ...
   for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            if (pol2->length)
            {
               zmod_poly_set(R,res1);
               zmod_poly_divrem(Q, res1, res1, pol2);
   ...
   for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            if (pol2->length)
            {
               zmod_poly_set(R,pol2);
               zmod_poly_divrem(Q, pol2, res1, pol2);
...
int test_zmod_poly_div_basecase()
{
   int result = 1;
   ...
   for (count1 = 0; (count1 < 400) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            if (pol2->length)
            {
               zmod_poly_div_basecase(Q, res1, pol2);
...
int test_zmod_poly_newton_invert()
{
   ...
   for (count1 = 0; (count1 < 30) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 30) && (result == 1); count2++)
      {
         ...
         zmod_poly_set(poly2,poly);   
         zmod_poly_newton_invert(poly, poly, length);
      
         zmod_poly_mul_trunc_n(poly3, poly2, poly, length);
...
int test_zmod_poly_div_series()
{
   ...
   unsigned long count1;
   for (count1 = 0; (count1 < 3000) && (result == 1) ; count1++)
   {
      bits = randint(FLINT_BITS-2)+2;
      unsigned long modulus;
   ...
   for (count1 = 0; (count1 < 3000) && (result == 1) ; count1++)
   {
      ...
      printf("length = %ld, bits = %ld\n", length, bits);
         ...
         zmod_poly_set(poly3,poly2);

         zmod_poly_div_series(poly2, poly2, poly, length);
      
         zmod_poly_mul_trunc_n(poly4, poly2, poly, length);
            
         result = zmod_poly_equal(poly4, poly3);
   ...
   for (count1 = 0; (count1 < 3000) && (result == 1) ; count1++)
   {
      ...
      printf("length = %ld, bits = %ld\n", length, bits);
         ...
         zmod_poly_set(poly3,poly);       
         zmod_poly_div_series(poly, poly2, poly, length);
      
         zmod_poly_mul_trunc_n(poly4, poly, poly3, length);
...
int test_zmod_poly_gcd_invert_euclidean()
{
   int result = 1;
   ...
   for (count1 = 0; (count1 < 100) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 50) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            zmod_poly_gcd_invert_euclidean(res1, pol1, pol2);
   ...
   for (count1 = 0; (count1 < 100) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 50) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            zmod_poly_gcd_invert_euclidean(pol1, pol1, pol2);
            zmod_poly_mul(res2, res1, pol1);
            zmod_poly_divrem_newton(res4, res3, res2, pol2);
   ...
   for (count1 = 0; (count1 < 100) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 50) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            zmod_poly_gcd_invert_euclidean(pol2, pol1, pol2);
...
int test_zmod_poly_gcd_invert_hgcd()
{
   int result = 1;
   zmod_poly_t pol1, pol2, pol3, res1, res2, res3, res4;
   unsigned long bits;
   ...
   for (count1 = 0; (count1 < 50) && (result == 1); count1++)
   {
      ...
      unsigned long count2;
      for (count2 = 0; (count2 < 20) && (result == 1); count2++)
      {
         unsigned long length1 = randint(1000)+1;
         unsigned long length2 = randint(1000)+2;
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            zmod_poly_gcd_invert_hgcd(res1, pol1, pol2);
            zmod_poly_mul(res2, res1, pol1);
            zmod_poly_divrem_newton(res4, res3, res2, pol2);
...
int test_zmod_poly_xgcd_euclidean()
{
   int result = 1;
   ...
   for (count1 = 0; (count1 < 50) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 20) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            zmod_poly_xgcd_euclidean(res1, s, t, pol1, pol2);
            if (pol3->length != 0) zmod_poly_divrem_newton(res2, res3, res1, pol3);
            else zmod_poly_zero(res3);
	...
	for (count1 = 0; (count1 < 50) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 20) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            zmod_poly_set(res1,pol1);
            zmod_poly_xgcd_euclidean(pol1, s, t, pol1, pol2);
            if (pol3->length != 0) zmod_poly_divrem_newton(res2, res3, pol1, pol3);
            else zmod_poly_zero(res3);
	...
	for (count1 = 0; (count1 < 50) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 20) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            zmod_poly_set(res1,pol2);
            zmod_poly_xgcd_euclidean(pol2, s, t, pol1, pol2);
            if (pol3->length != 0) zmod_poly_divrem_newton(res2, res3, pol2, pol3);
            else zmod_poly_zero(res3);
	...
	for (count1 = 0; (count1 < 50) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 20) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            zmod_poly_xgcd_euclidean(res1, pol1, t, pol1, pol2);
            if (pol3->length != 0) zmod_poly_divrem_newton(res2, res3, res1, pol3);
            else zmod_poly_zero(res3);
	...
	for (count1 = 0; (count1 < 50) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 20) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            zmod_poly_xgcd_euclidean(res1, pol2, t, pol1, pol2);
            if (pol3->length != 0) zmod_poly_divrem_newton(res2, res3, res1, pol3);
            else zmod_poly_zero(res3);
	...
	for (count1 = 0; (count1 < 50) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 20) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            zmod_poly_xgcd_euclidean(res1, s, pol1, pol1, pol2);
            if (pol3->length != 0) zmod_poly_divrem_newton(res2, res3, res1, pol3);
            else zmod_poly_zero(res3);
	...
	for (count1 = 0; (count1 < 50) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 20) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            zmod_poly_xgcd_euclidean(res1, s, pol2, pol1, pol2);
            if (pol3->length != 0) zmod_poly_divrem_newton(res2, res3, res1, pol3);
            else zmod_poly_zero(res3);
...
int test_zmod_poly_xgcd()
{
   ...
   unsigned long count1;
   for (count1 = 0; (count1 < 10) && (result == 1); count1++)
   {
      bits = randint(FLINT_BITS-2)+2;
      unsigned long modulus;
      ...
      {
         unsigned long length1 = randint(1000)+1;
         unsigned long length2 = randint(1000)+1;
         unsigned long length3 = randint(100);
   ...
   for (count1 = 0; (count1 < 50) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 20) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            zmod_poly_xgcd_hgcd(res1, s, t, pol1, pol2);
            if (pol3->length != 0) zmod_poly_divrem_newton(res2, res3, res1, pol3);
            else zmod_poly_zero(res3);
	...
	for (count1 = 0; (count1 < 50) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 20) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            zmod_poly_set(res1,pol1);
            zmod_poly_xgcd_hgcd(pol1, s, t, pol1, pol2);
            if (pol3->length != 0) zmod_poly_divrem_newton(res2, res3, pol1, pol3);
            else zmod_poly_zero(res3);
	...
	for (count1 = 0; (count1 < 50) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 20) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            zmod_poly_set(res1,pol2);
            zmod_poly_xgcd_hgcd(pol2, s, t, pol1, pol2);
            if (pol3->length != 0) zmod_poly_divrem_newton(res2, res3, pol2, pol3);
            else zmod_poly_zero(res3);
   ...
   for (count1 = 0; (count1 < 500) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
            ...
            if (!result)
            {
               ...
               zmod_poly_print(pol2); printf("\n\n");
               unsigned long i;
               for (i = 0; i < r1; i++) printf("%ld, ", roots1[i]); 
               printf("\n");
               unsigned long i;
               for (i = 0; i < r2; i++) printf("%ld, ", roots2[i]); 
               printf("\n");
            }
#endif
...
int test_zmod_poly_resultant()
{
   int result = 1;
   zmod_poly_t pol1, pol2, pol3, lin;
   unsigned long bits;
      ...
      for (count2 = 0; (count2 < 20) && (result == 1); count2++)
      {
            ...
            for (i = 0; i < r2; i++)
            {
               ...
               zmod_poly_mul(pol2, pol2, lin);
				...
				ulong length1 = randint(1000) + 1;
				ulong length2 = randint(1000) + 1;

				randpoly(pol3, length1, modulus);  
				zmod_poly_mul(pol1, pol1, pol3);
            
				randpoly(pol3, length2, modulus);
            zmod_poly_mul(pol2, pol2, pol3);
            
            unsigned long res1, res2;

            res1 = zmod_poly_resultant_euclidean(pol1, pol2);
            res2 = zmod_poly_resultant(pol1, pol2);
...
int test_zmod_poly_mulmod()
{
   ...
   for (count1 = 0; (count1 < 1000) && (result == 1); count1++)
   {
      ...
      unsigned long count2;
      for (count2 = 0; (count2 < 1) && (result == 1); count2++)
      {
         unsigned long length1 = randint(400);
         unsigned long length2 = randint(400);
...
int test_zmod_poly_powmod()
{
   ...
   unsigned long count1;
   for (count1 = 0; (count1 < 1500) && (result == 1); count1++)
   {
      bits = randint(FLINT_BITS-2)+2;
      unsigned long modulus;
      ...
      zmod_poly_factor_square_free(res, pol1);
	   ...
	   result &= (res->num_factors == num_factors);
		...
		if (!result)
		{
			...
			ulong i;
			for (i = 0; i < res->num_factors; i++) printf("%ld ", res->exponents[i]);
			printf("\n");
         ulong i;
         for (i = 0; i < num_factors; i++) printf("%ld ", exponents[i]);
			printf("\n");
		}
...
{
   int result = 1;
   zmod_poly_t pol1, pol2, pol3, pol4, pol5, res1;
   ...
   for (count1 = 0; (count1 < 100) && (result == 1); count1++)
   {
      ...
      zmod_poly_init(pol2, modulus);
      zmod_poly_init(pol3, modulus);
      zmod_poly_init(pol4, modulus);
      zmod_poly_init(pol5, modulus);
      zmod_poly_init(res1, modulus);
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            ulong d_red = pol1->length/2 + 1;
				...
				zmod_poly_half_gcd(Q, pol4, pol5, pol1, pol2);
      ...
      zmod_poly_clear(pol2);
      zmod_poly_clear(pol3);
      zmod_poly_clear(pol4);
      zmod_poly_clear(pol5);
      zmod_poly_clear(res1); 
   }
      ...
      for (count2 = 0; (count2 < 100) && (result == 1); count2++)
      {
         ...
         printf("length1 = %ld, length2 = %ld, bits = %ld, modulus = %ld\n", length1, length2, bits, modulus);
            ...
            ulong d_red = pol1->length/2 + 1;
				...
				zmod_poly_half_gcd_iter(Q, pol4, pol5, pol1, pol2);
            zmod_poly_swap(Q->a, Q->d);
				zmod_poly_neg(Q->b, Q->b);
				zmod_poly_neg(Q->c, Q->c);
...
int test_zmod_poly_gcd()
{
   ...
   for (count1 = 0; (count1 < 20) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 30) && (result == 1); count2++)
      {
         unsigned long length1 = randint(300)+1;
         unsigned long length2 = randint(300)+1;
         unsigned long length3 = randint(100);
...
int test_zmod_poly_evaluate()
{
   int result = 1;
   zmod_poly_t pol1;
   unsigned long bits, c, val1, val2;
   ...
   for (count1 = 0; (count1 < 1000) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 20) && (result == 1); count2++)
      {
         unsigned long length1 = randint(300);
		 ...
		 {
			 val1 = pol1->coeffs[pol1->length - 1];
			 long i;
			 for (i = pol1->length - 1; i > 0; i--)
			 {
				 val1 = z_mulmod2_precomp(val1, c, pol1->p, pol1->p_inv);
				 val1 = z_addmod(val1, pol1->coeffs[i - 1], pol1->p);
			 }
		 }

		 val2 = zmod_poly_evaluate(pol1, c);
...
int test_zmod_poly_compose_horner()
{
   int result = 1;
   zmod_poly_t pol1, pol2, res1, res2;
   unsigned long bits;
   ...
   for (count1 = 0; (count1 < 50) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 30) && (result == 1); count2++)
      {
         unsigned long length1 = randint(30);
         unsigned long length2 = randint(30);
		 ...
		 zmod_poly_fit_length(res1, 1);
		 
		 if (pol1->length == 0) zmod_poly_zero(res1);
		 else
		 {
			 zmod_poly_set_coeff_ui(res1, 0, pol1->coeffs[pol1->length - 1]);
			 res1->length = 1;
			 long n;
			 for (n = pol1->length - 1; n > 0L; n--)
			 {
				 zmod_poly_mul(res1, res1, pol2);
                 if (res1->length == 0) 
				 {
					 res1->length = 1;
				     res1->coeffs[0] = pol1->coeffs[n - 1];
				 } else
				 {
					 res1->coeffs[0] = z_addmod(res1->coeffs[0], pol1->coeffs[n - 1], pol1->p);
					 if (res1->length == 0) res1->length = 1;
				 }
				 __zmod_poly_normalise(res1);
			 }
		 }

         zmod_poly_compose_horner(res2, pol1, pol2);
   ...
   for (count1 = 0; (count1 < 50) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 30) && (result == 1); count2++)
      {
         ...
         zmod_poly_compose_horner(res2, pol1, pol1);
   ...
   for (count1 = 0; (count1 < 50) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 30) && (result == 1); count2++)
      {
         ...
         zmod_poly_compose_horner(pol1, pol1, pol2);
   ...
   for (count1 = 0; (count1 < 50) && (result == 1); count1++)
   {
      ...
      for (count2 = 0; (count2 < 30) && (result == 1); count2++)
      {
         ...
         zmod_poly_compose_horner(pol2, pol1, pol2);
...
void zmod_poly_test_all()
{
   ...
   RUN_TEST(zmod_poly_divrem_basecase); 
   RUN_TEST(zmod_poly_rem_basecase); 
   RUN_TEST(zmod_poly_divrem_newton); 
   RUN_TEST(zmod_poly_rem_newton); 
   RUN_TEST(zmod_poly_divrem); 
   RUN_TEST(zmod_poly_rem); 
   RUN_TEST(zmod_poly_div_basecase); 
   ...
   RUN_TEST(zmod_poly_div_newton); 
	RUN_TEST(zmod_poly_divrem_q1); 
   RUN_TEST(zmod_poly_rem_q1); 
   RUN_TEST(zmod_poly_divrem_q0); 
   RUN_TEST(zmod_poly_rem_q0); 
   ...
   RUN_TEST(zmod_poly_gcd_invert_euclidean); 
   RUN_TEST(zmod_poly_gcd_invert_hgcd); 
   RUN_TEST(zmod_poly_gcd_invert); 
   RUN_TEST(zmod_poly_xgcd_euclidean); 
	RUN_TEST(zmod_poly_xgcd_hgcd); 
	RUN_TEST(zmod_poly_xgcd); 
	RUN_TEST(zmod_poly_resultant_euclidean);
   RUN_TEST(zmod_poly_resultant);
   RUN_TEST(zmod_poly_mulmod); 
   RUN_TEST(zmod_poly_powmod); 
   RUN_TEST(zmod_poly_evaluate); 
