...
void intrel(F_mpz_mat_t B, int bits, int d)
{
   long i, j;
...
void simdioph(F_mpz_mat_t B, int bits, int bits2, int d)
{
   int i, j;
...
void goldstein_mayer(F_mpz_mat_t B, int bits, int d)
{
   int i, j;
   mpz_t temp;
	mpz_init(temp);
...
void uniform(F_mpz_mat_t B, int bits, int d)
{
   int i, j;
