...
\begin{lstlisting}
void F_mpz_mod_preinv(F_mpz_t f, const F_mpz_t g, const F_mpz_t p, mp_srcptr pinv)
\end{lstlisting}
\begin{quote}
...
\begin{lstlisting}
void F_mpz_smod_preinv(F_mpz_t f, const F_mpz_t g, const F_mpz_t h, mp_srcptr pinv)
\end{lstlisting}
\begin{quote}
