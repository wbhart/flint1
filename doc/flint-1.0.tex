...
\title{FLINT 1.0.1: Fast Library for Number Theory}
...
Next, set the environment variables \code{FLINT_GMP_LIB_DIR} and \code{FLINT_GMP_INCLUDE_DIR} to point to your GMP library and include directories respectively. 
