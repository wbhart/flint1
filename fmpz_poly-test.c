...
#endif
          mpz_poly_to_fmpz_poly(test_mpn_poly, test_poly);
          _fmpz_poly_truncate(test_mpn_poly, trunc);
          fmpz_poly_check_normalisation(test_mpn_poly);
          fmpz_poly_to_mpz_poly(test_poly2, test_mpn_poly);
...
int test__fmpz_poly_bits()
{
   ...
   for (unsigned long count1 = 1; (count1 < 300) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          mpz_poly_to_fmpz_poly(test_mpn_poly, test_poly);
          fmpz_bits = _fmpz_poly_bits(test_mpn_poly);
...
int test__fmpz_poly_bits1()
{
   ...
   for (unsigned long count1 = 1; (count1 < 300) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          mpz_poly_to_fmpz_poly(test_mpn_poly, test_poly);
          fmpz_bits = _fmpz_poly_bits1(test_mpn_poly);
...
int test__fmpz_poly_max_limbs()
{
   ...
   for (unsigned long count1 = 1; (count1 < 300) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          mpz_poly_to_fmpz_poly(test_mpn_poly, test_poly);
          fmpz_limbs = _fmpz_poly_max_limbs(test_mpn_poly);
...
#endif
          mpz_poly_to_fmpz_poly(test_mpn_poly, test_poly);
          _fmpz_poly_attach(test_mpn_poly2, test_mpn_poly);
          _fmpz_poly_check_normalisation(test_mpn_poly2);
...
int test__fmpz_poly_attach_shifted()
{
   mpz_poly_t test_poly, test_poly2;
   fmpz_poly_t test_mpn_poly, test_mpn_poly2;
   mpz_t temp;
...
#endif
          mpz_poly_to_fmpz_poly(test_mpn_poly, test_poly);
          _fmpz_poly_attach_shifted(test_mpn_poly2, test_mpn_poly, shift);
          _fmpz_poly_check_normalisation(test_mpn_poly2);
          fmpz_poly_to_mpz_poly(test_poly2, test_mpn_poly2);
          _fmpz_poly_right_shift(test_mpn_poly, test_mpn_poly, shift);
          fmpz_poly_to_mpz_poly(test_poly, test_mpn_poly);
#if DEBUG
          for (unsigned j = 0; j < test_poly2->length; j++)
             gmp_printf("%Zd, ",test_poly2->coeffs[j]);
          printf("\n\n");
...
#endif
          mpz_poly_to_fmpz_poly(test_mpn_poly, test_poly);
          _fmpz_poly_attach_truncate(test_mpn_poly2, test_mpn_poly, trunc);
          _fmpz_poly_check_normalisation(test_mpn_poly2);
          fmpz_poly_to_mpz_poly(test_poly2, test_mpn_poly2);
          _fmpz_poly_truncate(test_mpn_poly, trunc);
          fmpz_poly_to_mpz_poly(test_poly, test_mpn_poly);
   ...
   for (unsigned long count1 = 1; (count1 < 200) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          for (unsigned long count3 = 1; (count3 < 1000) && result == 1; count3++)
          {
              ...
              coeff_num = randint(test_mpn_poly->length);
...
int test_fmpz_poly_getset_coeff_mpz()
{
   ...
   for (unsigned long count1 = 1; (count1 < 400) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          _fmpz_poly_get_coeff_mpz(coeff1, test_mpn_poly, randint(test_mpn_poly->length));
          rand_coeff = randint(test_mpn_poly->length);
          if (test_mpn_poly->length)
          {
             _fmpz_poly_set_coeff_mpz(test_mpn_poly, rand_coeff, coeff1);
             fmpz_poly_check_normalisation(test_mpn_poly);
             _fmpz_poly_get_coeff_mpz(coeff2, test_mpn_poly, rand_coeff);
...
int test_fmpz_poly_freadprint()
{
   ...
   for (unsigned long count1 = 1; (count1 < 200) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          fmpz_poly_fprint(test_mpn_poly, testfile);
          fclose(testfile);
          testfile = fopen("testfile", "r");
          fmpz_poly_fread(test_mpn_poly2, testfile);
          fclose(testfile);
          fmpz_poly_check_normalisation(test_mpn_poly2);
          result = _fmpz_poly_equal(test_mpn_poly2, test_mpn_poly);
...
int test_fmpz_poly_tofromstring()
{
   ...
   for (unsigned long count1 = 1; (count1 < 200) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          char * strbuf = fmpz_poly_to_string(test_mpn_poly);
          int OK = fmpz_poly_from_string(test_mpn_poly2, strbuf);
          free(strbuf);
          fmpz_poly_check_normalisation(test_mpn_poly2);
          result = _fmpz_poly_equal(test_mpn_poly2, test_mpn_poly) && OK;
...
int test__fmpz_poly_zero_coeffs()
{
   ...
   for (unsigned long count1 = 1; (count1 < 200) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          zeroes = randint(test_mpn_poly->length + 1);
          
          _fmpz_poly_zero_coeffs(test_mpn_poly2, zeroes);
          fmpz_poly_check_normalisation(test_mpn_poly2);
          
          unsigned long i;
          fmpz_t coeff1, coeff2;
          
          if (zeroes == test_mpn_poly->length)
          {
             result = (test_mpn_poly2->length == 0);
          } else
          {
             for (i = 0; i < zeroes; i++)
             {
                coeff1 = _fmpz_poly_get_coeff_ptr(test_mpn_poly2, i);
                result &= fmpz_is_zero(coeff1);
             }
             for (i = zeroes; i < test_mpn_poly->length; i++)
             {
                coeff1 = _fmpz_poly_get_coeff_ptr(test_mpn_poly, i);
                coeff2 = _fmpz_poly_get_coeff_ptr(test_mpn_poly2, i);
                result &= fmpz_equal(coeff1, coeff2);
             }
          }
      }
...
int test_fmpz_poly_swap()
{
   ...
   for (unsigned long count1 = 1; (count1 < 200) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          fmpz_poly_fit_length(test_mpn_poly2, length2);
          fmpz_poly_fit_length(test_mpn_poly3, length);
          randpoly(test_poly, length2, bits);
          mpz_poly_to_fmpz_poly(test_mpn_poly2, test_poly);
          
          _fmpz_poly_set(test_mpn_poly3, test_mpn_poly);
          fmpz_poly_swap(test_mpn_poly, test_mpn_poly2);
          fmpz_poly_check_normalisation(test_mpn_poly);
          fmpz_poly_check_normalisation(test_mpn_poly2);
...
#endif
          shift = randint(100);
          fmpz_poly_fit_length(test_mpn_poly, length+shift);
          fmpz_poly_fit_length(test_mpn_poly2, length+shift);
...
int test_fmpz_poly_neg()
{
   ...
   for (unsigned long count1 = 1; (count1 < 200) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          fmpz_poly_check_normalisation(test_mpn_poly3);
          
          if (length == 0) result = (test_mpn_poly2->length == 0);
          else result = _fmpz_poly_equal(test_mpn_poly, test_mpn_poly3) 
...
int test_fmpz_poly_add()
{
   ...
   for (unsigned long count1 = 1; (count1 < 200) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          fmpz_poly_fit_length(test_mpn_poly3, max_length);
...
int test_fmpz_poly_mul_classical_trunc()
{
   ...
   for (unsigned long count1 = 1; (count1 < 100) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          fmpz_poly_check_normalisation(test_mpn_poly4);
...
int test_fmpz_poly_mul_classical_trunc_left()
{
   ...
   for (unsigned long count1 = 1; (count1 < 100) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          if (length + length2 < 2)
          {
             fmpz_poly_init2(test_mpn_poly3, 1, (bits+bits2-1)/FLINT_BITS+2);
             fmpz_poly_init2(test_mpn_poly4, 1, (bits+bits2-1)/FLINT_BITS+2);
          } else
          {
             fmpz_poly_init2(test_mpn_poly3, length+length2-1, (bits+bits2-1)/FLINT_BITS+2);
...
int test_fmpz_poly_mul_karatsuba()
{
   ...
   for (unsigned long count1 = 0; (count1 < 10000) && (result == 1) ; count1++)
   {
      ...
      mpz_poly_init(test_poly4);
      if (length + length2) fmpz_poly_init2(test_mpn_poly3, length+length2-1, test_mpn_poly->limbs+test_mpn_poly2->limbs+1); //(output_bits-1)/FLINT_BITS+1);
      else fmpz_poly_init(test_mpn_poly3);
...
int test_fmpz_poly_mul_karatsuba_trunc()
{
   ...
   for (unsigned long count1 = 1; (count1 < 1000) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          if (length + length2) fmpz_poly_init2(test_mpn_poly3, length+length2-1, (bits+bits2-1)/FLINT_BITS+2);
          else fmpz_poly_init(test_mpn_poly3);
          fmpz_poly_init2(test_mpn_poly4, trunc, (bits+bits2-1)/FLINT_BITS+2);
...
int test_fmpz_poly_mul_karatsuba_trunc_left()
{
   mpz_poly_t test_poly, test_poly2, test_poly3, test_poly4;
   fmpz_poly_t test_mpn_poly, test_mpn_poly2, test_mpn_poly3, test_mpn_poly4;
   int result = 1;
...
int test_fmpz_poly_mul_KS()
{
   ...
   for (unsigned long count1 = 0; count1 < 60; count1++)
   {
      ...
      if (length + length2) _fmpz_poly_stack_init(test_mpn_poly3, length + length2 - 1, test_mpn_poly->limbs + test_mpn_poly2->limbs + 1);
      else fmpz_poly_init(test_mpn_poly3);
...
int test_fmpz_poly_mul_SS()
{
   ...
   for (unsigned long count1 = 0; (count1 < 50) && (result == 1) ; count1++)
   {
      ...
      mpz_poly_init(test_poly4);
      if (length + length2) fmpz_poly_init2(test_mpn_poly3, length+length2-1, test_mpn_poly->limbs+test_mpn_poly2->limbs+1);
      else fmpz_poly_init(test_mpn_poly3);
...
int test__fmpz_poly_mul_trunc_left_n()
{
   ...
   for (unsigned long count1 = 1; (count1 < 25) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          _fmpz_poly_mul_KS(test_mpn_poly3, test_mpn_poly, test_mpn_poly2);
          _fmpz_poly_zero_coeffs(test_mpn_poly3, trunc);
          
          _fmpz_poly_mul_trunc_left_n(test_mpn_poly4, test_mpn_poly, test_mpn_poly2, trunc);
          fmpz_poly_check_normalisation(test_mpn_poly4);
          _fmpz_poly_zero_coeffs(test_mpn_poly4, trunc);
...
int test_fmpz_poly_scalar_div()
{
   ...
   for (unsigned long count1 = 0; (count1 < 10000) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          for (unsigned long j = 0; j < 5; j++)
          {
            fmpz_poly_scalar_div(test_mpn_poly2, test_mpn_poly, x);
            fmpz_poly_check_normalisation(test_mpn_poly2);
          }
...
int test_fmpz_poly_scalar_div_mpz()
{
   ...
   for (unsigned long count1 = 0; (count1 < 10000) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          for (unsigned long j = 0; j < 5; j++)
          {
            fmpz_poly_scalar_div_mpz(test_mpn_poly2, test_mpn_poly, x_mpz);
            fmpz_poly_check_normalisation(test_mpn_poly2);
          }
...
int test_fmpz_poly_scalar_mul_mpz()
{
   ...
   for (unsigned long count1 = 0; (count1 < 7) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          for (unsigned long j = 0; j < 1; j++)
          {
             fmpz_poly_scalar_mul_mpz(test_mpn_poly2, test_mpn_poly, x_mpz);
             fmpz_poly_check_normalisation(test_mpn_poly2);
          }
...
int test_fmpz_poly_newton_invert_basecase()
{
   ...
   for (unsigned long count1 = 0; (count1 < 20000) && (result == 1) ; count1++)
   {
      ...
      fmpz_poly_set_coeff_ui(test_mpn_poly, test_mpn_poly->length - 1, 1L);
...
int test_fmpz_poly_pseudo_divrem_cohen()
{
   ...
   for (unsigned long count1 = 0; (count1 < 1000) && (result == 1) ; count1++)
   {
      ...
      for (unsigned long i = 1; i < 5; i++)
      {
         fmpz_poly_pseudo_divrem_cohen(test_mpn_poly4, test_mpn_poly5, test_mpn_poly3, test_mpn_poly);
         fmpz_poly_check_normalisation(test_mpn_poly4);
         fmpz_poly_clear(test_mpn_poly4);
         fmpz_poly_clear(test_mpn_poly5);
         fmpz_poly_init(test_mpn_poly4);
...
int test_fmpz_poly_pseudo_divrem_schoup()
{
   mpz_poly_t test_poly, test_poly2, test_poly3, test_poly4;
   fmpz_poly_t test_mpn_poly, test_mpn_poly2, test_mpn_poly3, test_mpn_poly4, test_mpn_poly5;
   int result = 1;
   ...
   for (unsigned long count1 = 0; (count1 < 1000) && (result == 1) ; count1++)
   {
      ...
      for (unsigned long i = 1; i < 5; i++)
      {
         fmpz_poly_pseudo_divrem_schoup(test_mpn_poly4, test_mpn_poly5, test_mpn_poly3, test_mpn_poly);
         fmpz_poly_check_normalisation(test_mpn_poly4);
         fmpz_poly_clear(test_mpn_poly4);
         fmpz_poly_clear(test_mpn_poly5);
         fmpz_poly_init(test_mpn_poly4);
...
int test_fmpz_poly_pseudo_divrem_basecase()
{
   ...
   for (unsigned long count1 = 0; (count1 < 6000) && (result == 1) ; count1++)
   {
      ...
      for (unsigned long i = 1; i < 5; i++)
      {
         fmpz_poly_pseudo_divrem_basecase(test_mpn_poly4, test_mpn_poly5, &d, test_mpn_poly3, test_mpn_poly);
         fmpz_poly_check_normalisation(test_mpn_poly4);
         fmpz_poly_clear(test_mpn_poly4);
         fmpz_poly_clear(test_mpn_poly5);
         fmpz_poly_init(test_mpn_poly4);
...
int test_fmpz_poly_pseudo_div_basecase()
{
   ...
   for (unsigned long count1 = 0; (count1 < 6000) && (result == 1) ; count1++)
   {
      ...
      for (unsigned long i = 1; i < 5; i++)
      {
         fmpz_poly_pseudo_div_basecase(test_mpn_poly4, &d, test_mpn_poly3, test_mpn_poly);
         fmpz_poly_check_normalisation(test_mpn_poly4);
         fmpz_poly_clear(test_mpn_poly4);
         fmpz_poly_init(test_mpn_poly4);
      }
...
int test_fmpz_poly_pseudo_div_recursive()
{
   ...
   for (unsigned long count1 = 0; (count1 < 600) && (result == 1) ; count1++)
   {
      ...
      for (unsigned long i = 1; i < 5; i++)
      {
         fmpz_poly_pseudo_div_recursive(test_mpn_poly4, &d, test_mpn_poly3, test_mpn_poly);
         fmpz_poly_check_normalisation(test_mpn_poly4);
         fmpz_poly_clear(test_mpn_poly4);
         fmpz_poly_init(test_mpn_poly4);
      }
...
int test_fmpz_poly_to_ZmodF_poly()
{
   ...
   for (unsigned long count1 = 1; (count1 < 1000) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          fmpz_poly_to_ZmodF_poly(test_modF_poly, test_mpn_poly, length);
          ZmodF_poly_to_fmpz_poly(test_mpn_poly2, test_modF_poly, 1);
          fmpz_poly_to_mpz_poly(test_poly2, test_mpn_poly2);
...
int test_fmpz_poly_bit_pack()
{
   ...
   for (unsigned long count1 = 1; (count1 < 1000) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          fmpz_poly_bit_pack(test_modF_poly, test_mpn_poly, bundle, -bits, length, 1L);
          ...
          fmpz_poly_bit_unpack(test_mpn_poly2, test_modF_poly, bundle, bits); 
          fmpz_poly_check_normalisation(test_mpn_poly2); 
          fmpz_poly_to_mpz_poly(test_poly2, test_mpn_poly2);
...
int test_fmpz_poly_bit_pack_unsigned()
{
   ...
   for (unsigned long count1 = 1; (count1 < 1000) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          fmpz_poly_bit_unpack_unsigned(test_mpn_poly2, test_modF_poly, bundle, bits);
          fmpz_poly_check_normalisation(test_mpn_poly2);  
          fmpz_poly_to_mpz_poly(test_poly2, test_mpn_poly2);
...
int test_fmpz_poly_limb_pack_unsigned()
{
   ...
   for (unsigned long count1 = 1; (count1 < 1000) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          fmpz_poly_limb_pack(test_modF_poly, test_mpn_poly, length, limbs);
                  
          fmpz_poly_limb_unpack_unsigned(test_mpn_poly2, test_modF_poly, length, limbs);
          fmpz_poly_check_normalisation(test_mpn_poly2);  
          test_mpn_poly2->length = length;
          fmpz_poly_to_mpz_poly(test_poly2, test_mpn_poly2);
...
int test_fmpz_poly_limb_pack()
{
   ...
   for (unsigned long count1 = 1; (count1 < 1000) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          fmpz_poly_limb_unpack(test_mpn_poly2, test_modF_poly, length, limbs);  
          fmpz_poly_check_normalisation(test_mpn_poly2);
          test_mpn_poly2->length = length;
          fmpz_poly_to_mpz_poly(test_poly2, test_mpn_poly2);
...
int test_fmpz_poly_byte_pack_unsigned()
{
   ...
   for (unsigned long count1 = 1; (count1 < 200) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          {
             fmpz_poly_byte_pack(test_modF_poly, test_mpn_poly, length, bytes, length, 1L);
             test_mpn_poly2->length = length;
          
             for (unsigned long i = 0; i < length; i++) // Must clear coeffs in advance
                test_mpn_poly2->coeffs[i*(test_mpn_poly2->limbs+1)] = 0; 
             
             fmpz_poly_byte_unpack_unsigned(test_mpn_poly2, test_modF_poly->coeffs[0], length, bytes);  
             fmpz_poly_check_normalisation(test_mpn_poly2);
          }
          fmpz_poly_to_mpz_poly(test_poly2, test_mpn_poly2);
   ...
   for (unsigned long count1 = 1; (count1 < 5) && (result == 1) ; count1++)
   {
      ...
      { 
          ...
          for (unsigned long j = 0; j < 100; j++)
          {
             ...
             fmpz_poly_byte_unpack(test_mpn_poly2, test_modF_poly->coeffs[0], length, bytes);  
             fmpz_poly_check_normalisation(test_mpn_poly2);
          }
          fmpz_poly_to_mpz_poly(test_poly2, test_mpn_poly2);
...
void fmpz_poly_test_all()
{
   ...
   RUN_TEST(_fmpz_poly_attach_shifted);
   RUN_TEST(_fmpz_poly_attach_truncate);
   RUN_TEST(_fmpz_poly_truncate);
   RUN_TEST(_fmpz_poly_bits);
   RUN_TEST(_fmpz_poly_bits1);
