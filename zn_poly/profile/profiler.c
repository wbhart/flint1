...
estimate_cycle_scale_factor ()
{
   ...
   for (count = 1; count < ULONG_MAX / 4; )
   {
      ...
      long long u1 = (long long) usage1.ru_utime.tv_usec +
                     (long long) usage1.ru_utime.tv_sec * 1000000;
      long long u2 = (long long) usage2.ru_utime.tv_usec +
                     (long long) usage2.ru_utime.tv_sec * 1000000;
