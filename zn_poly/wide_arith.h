...
/*
   Temporarily in zn_poly-0.8:
   
   The following macros are for backward compatibility. The only program that
   uses them is an older version of hypellfrob. That might co-exist
   temporarily with zn_poly-0.8 in Sage 3.0, so we have these here for the
   moment. todo: delete these macros in the next zn_poly version.
*/
#define MUL_WIDE ZNP_MUL_WIDE
#define MUL_HI   ZNP_MUL_HI
#define ADD_WIDE ZNP_ADD_WIDE
#define SUB_WIDE ZNP_SUB_WIDE
