...
arg should point to an unsigned long, which is the transform depth
*/
void sample_ZmodF_sqr_negacyclic(unsigned long n, void* arg,
                                 unsigned long count)
{
   unsigned long depth = * (unsigned long*) arg;
   ZmodF_mul_info_t info;
...
char* profDriverString_ZmodF_sqr_negacyclic(char* params)
{
   return
   "ZmodF_sqr using negacyclic algorithm.\n"
   "Parameters: depth, n_min, n_max, n_skip.\n"
   "Note: those n not supported for the given depth are skipped.\n";
}


char* profDriverDefaultParams_ZmodF_sqr_negacyclic()
{
   return "4 1 1000 1";
}


void profDriver_ZmodF_sqr_negacyclic(char* params)
{
   unsigned long depth, n_min, n_max, n_skip;
   sscanf(params, "%ld %ld %ld %ld", &depth, &n_min, &n_max, &n_skip);

   prof1d_set_sampler(sample_ZmodF_sqr_negacyclic);
...
arg should point to an unsigned long, which is the transform depth
*/
void sample_ZmodF_sqr_negacyclic2(unsigned long n, void* arg,
                                  unsigned long count)
{
   unsigned long depth = * (unsigned long*) arg;
   ZmodF_mul_info_t info;
...
char* profDriverString_ZmodF_sqr_negacyclic2(char* params)
{
   return
   "ZmodF_sqr using 2nd negacyclic algorithm.\n"
   "Parameters: depth, n_min, n_max, n_skip.\n"
   "Note: those n not supported for the given depth are skipped.\n";
}


char* profDriverDefaultParams_ZmodF_sqr_negacyclic2()
{
   return "4 1 1000 1";
}


void profDriver_ZmodF_sqr_negacyclic2(char* params)
{
   unsigned long depth, n_min, n_max, n_skip;
   sscanf(params, "%ld %ld %ld %ld", &depth, &n_min, &n_max, &n_skip);

   prof1d_set_sampler(sample_ZmodF_sqr_negacyclic2);
