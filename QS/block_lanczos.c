...
uint64_t random32(void) {
   ...
   /* Poor man's random number generator. It satisfies no 
    ...
    randval = ((uint64_t)randval*1025416097U+286824428U)%(uint64_t)4294967291U;
...
static void mul_64xN_Nx64(uint64_t *x, uint64_t *y,
			   uint64_t *c, uint64_t *xy, unsigned long n) {
...
/*-------------------------------------------------------------------*/
static unsigned long find_nonsingular_sub(uint64_t *t, unsigned long *s, 
...
/*-----------------------------------------------------------------------*/
static void transpose_vector(unsigned long ncols, uint64_t *v, uint64_t **trans) {
...
/*-----------------------------------------------------------------------*/
uint64_t * block_lanczos(unsigned long nrows, 
